...
rm script_SLIM4_3L_total_selpos.sh.*
...
cp 3Lsel_list_allsnps.txt list_allsnps
sed -i -e 's/3L/1/g' list_allsnps
cp 3Lsel_dataBP.ped dataBP.ped
...
cp 3Lsel_qselpos.txt 3Lsel_qselpos$r.txt
...
cp -r 3Lsel_qselpos$r.txt $WDIR/OUTPUT_$INPUT
